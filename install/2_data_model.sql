...
INSERT INTO tng.files VALUES
	(1, 'logo', 'oeaw.png', true, true, '2026-02-24 23:15:34.751634'),
	(2, 'logo', 'acdh.png', true, true, '2026-02-24 23:15:34.751634'),
	(3, 'logo', 'aiscr.png', true, true, '2026-02-24 23:15:34.751634'),
	(4, 'logo', 'thanados_light.svg', true, true, '2026-02-24 23:15:34.751634'),
	(5, 'logo', 'nhm.png', true, true, '2026-02-24 23:15:34.751634'),
	(6, 'logo', 'openatlas.png', true, true, '2026-02-24 23:15:34.751634'),
	(7, 'logo', 'iiif.png', true, true, '2026-02-24 23:15:34.751634'),
	(8, 'logo', 'oeai.png', true, true, '2026-02-24 23:15:34.751634'),
	(9, 'logo', 'thanados_dark.svg', true, true, '2026-02-24 23:15:34.751634'),
	(11, 'asset', 'Blank_map_of_Europe_central_network.png', true, true, '2026-02-24 23:27:01.327944'),
	(13, 'member', '011.jpg', false, true, '2026-02-27 11:39:44.454811'),
	(16, 'team', 'cool_chick1.jpg', true, true, '2026-02-27 11:55:54.263902'),
	(17, 'team', 'cool_dude1.jpg', true, true, '2026-02-27 11:55:54.264473'),
	(18, 'team', 'stefan_eichert_600x600.jpg', true, true, '2026-02-27 11:55:54.264911'),
	(19, 'team', 'cool_dude2.jpg', true, true, '2026-02-27 11:55:54.265353'),
	(22, 'team', '011.jpg', true, false, '2026-02-27 11:55:54.266796'),
	(23, 'team', '.gitignore', true, false, '2026-02-27 11:55:54.267188'),
	(30, 'logo', 'erc_eu.png', true, true, '2026-02-27 12:12:24.21957'),
	(31, 'logo', 'erc.png', true, true, '2026-02-27 12:12:24.220091'),
	(26, 'team', '010.jpg', false, false, '2026-02-27 11:58:25.236184'),
	(28, 'logo', 'ERC_logo.png', true, false, '2026-02-27 12:09:06.223285'),
	(35, 'logo', 'relic.png', false, true, '2026-02-27 12:40:36.387951'),
	(36, 'logo', 'uni_vie.png', true, true, '2026-02-27 13:00:49.133308'),
	(32, 'logo', '2025-12-24_08-06_1.png', true, false, '2026-02-27 12:15:47.093848'),
	(33, 'logo', '2025-12-24_08-06_1.png', true, false, '2026-02-27 12:15:54.344406'),
	(34, 'logo', '2025-12-24_08-06_1.png', true, false, '2026-02-27 12:15:58.881482'),
	(29, 'logo', 'Uni_Logo.png', true, false, '2026-02-27 12:09:06.223741'),
	(27, 'logo', 'Uni_Logo.jpg', true, false, '2026-02-27 12:09:06.222642');
...
INSERT INTO tng.maps VALUES
	(1, 'OpenStreetMap', 'Open Street Maps', 'https://api.maptiler.com/maps/bright/style.json?key=E7Jrgaazm79UlTuEI5f5
                    ', 1);
...
INSERT INTO tng.system_settings VALUES
	...
	('shown_classes', '["place", "feature", "stratigraphic_unit", "artifact", "human_remains", "person", "group", "acquisition", "event", "activity", "creation", "move", "production", "modification", "source", "bibliography", "external_reference", "edition", "file"]'),
	('shown_types', '[]'),
	('hidden_classes', '[]'),
	('hidden_types', '[]'),
	('shown_ids', '[]'),
	...
	('nav_logo', '"relic.png"'),
	('footer_logos', '[5, 30, 36, 6]'),
	('menu_management', '{"about": {"show": true, "page_type": "individual"}, "footer": {"show": true, "page_type": "default"}, "search": {"show": true, "page_type": "default"}, "outcome": {"show": true, "page_type": "individual"}, "start_page": {"show": false, "page_type": "individual"}, "publication": {"show": false, "page_type": "default"}, "legal_notice": {"show": false, "page_type": "default"}, "publications": {"show": false, "page_type": "default"}}'),
	('legal_notice', '{"de": "<p><strong>THANADOS &ndash; Die Anthropologische und Arch&auml;ologische Datenbank f&uuml;r Bestattungen</strong><br><br>Gehostet von:<br>Naturhistorisches Museum Wien (NHM Wien), Pr&auml;historische Abteilung&nbsp;<br>&amp; &Ouml;sterreichisches Arch&auml;ologisches Institut (&Ouml;AI) / &Ouml;sterreichische Akademie der Wissenschaften (&Ouml;AW)</p>\r\n<p><strong>Kontakt:<br></strong><strong>Naturhistorisches Museum Wien (AUT)<br></strong>Ansprechpartner: Mag. Dr. Stefan Eichert<br>E-Mail: stefan.eichert@nhm-wien.ac.at<br>Adresse: Burgring 7, 1010 Wien, &Ouml;sterreich<br><br></p>\r\n<p><strong>&Ouml;sterreichisches Arch&auml;ologisches Institut (&Ouml;AI / &Ouml;AW)</strong><br>Ansprechpartner: Nina Richards, MA BSc<br>E-Mail: nina.richards@oeaw.ac.at<br>Adresse: Rosenbursenstra&szlig;e 3, 1010 Wien, &Ouml;sterreich</p>\r\n<p><br><strong>Arch&auml;ologisches Institut der Akademie der Wissenschaften der Tschechischen Republik, Prag (CZ)</strong><br>Ansprechpartner: Mgr. David Nov&aacute;k, Ph.D.<br>E-Mail: novak@arup.cas.cz<br>Adresse: Letensk&aacute; 123/4, 118 01 Prag 1, Tschechien</p>\r\n<p>Die von THANADOS bereitgestellten Daten sind unter der&nbsp;<br><a href=\"https://creativecommons.org/licenses/by/4.0/\">Creative Commons Attribution 4.0 International License (CC BY 4.0)</a> lizenziert.<br>Die Software selbst wird unter der&nbsp;<br><a href=\"https://opensource.org/licenses/MIT\">MIT-Lizenz</a> ver&ouml;ffentlicht.</p>\r\n<p>Die Erstellung, Nutzung und nicht-kommerzielle Weitergabe von Kopien in elektronischer oder gedruckter Form sind gestattet, sofern der Inhalt nicht verf&auml;lscht und die Quelle angegeben wird (Quelle: NHM Wien). Texte, Bilder und Grafiken sind urheberrechtlich und durch andere Schutzgesetze gesch&uuml;tzt, sofern nicht anders angegeben. Trotz gr&ouml;&szlig;tm&ouml;glicher Sorgfalt bei der Erstellung dieser Website kann das NHM Wien keine Gew&auml;hr f&uuml;r die Fehlerfreiheit oder Richtigkeit der darin enthaltenen Informationen &uuml;bernehmen. Das NHM Wien schlie&szlig;t jegliche Haftung f&uuml;r Sch&auml;den aus, die direkt oder indirekt aus der Nutzung der Website entstehen.</p>", "en": "<p><strong>THANADOS &ndash; The Anthropological and Archaeological Database of Sepultures</strong><br><br>Hosted by:<br>Natural History Museum Vienna (NHM Vienna), Department of Prehistory&nbsp;<br>&amp; Austrian Archaeological Institute (&Ouml;AI) / Austrian Academy of Sciences (&Ouml;AW)</p>\r\n<p><strong>Contact:<br></strong><strong>Natural History Museum Vienna (AUT)<br></strong>Contact person: Mag. Dr. Stefan Eichert<br>E-mail: stefan.eichert@nhm-wien.ac.at<br>Address: Burgring 7, 1010 Vienna, Austria<br><br></p>\r\n<p><strong>Austrian Archaeological Institute (&Ouml;AI / &Ouml;AW)</strong><br>Contact person: Nina Richards, MA BSc<br>E-mail: nina.richards@oeaw.ac.at<br>Address: Rosenbursenstra&szlig;e 3, 1010 Vienna, Austria</p>\r\n<p><br><strong>Institute of Archaeology of the Czech Academy of Sciences, Prague (CZ)</strong><br>Contact person: Mgr. David Nov&aacute;k, Ph.D.<br>E-mail: novak@arup.cas.cz<br>Address: Letensk&aacute; 123/4, 118 01 Prague 1, Czechia</p>\r\n<p>The data provided by THANADOS are licensed under the&nbsp;<br><a href=\"https://creativecommons.org/licenses/by/4.0/\">Creative Commons Attribution 4.0 International License (CC BY 4.0)</a>.<br>The software itself is released under the&nbsp;<br><a href=\"https://opensource.org/licenses/MIT\">MIT License</a>.</p>\r\n<p>The creation, use, and non-commercial distribution of copies in<br>electronic or printed form are permitted, provided that the content is<br>not distorted and the source is acknowledged (source: NHM Vienna).<br>Texts, images, and graphics are protected by copyright and other<br>protective laws, unless otherwise indicated. Despite the greatest<br>possible care in the preparation of this website, the NHM Vienna cannot<br>guarantee the absence of errors or the accuracy of the information<br>contained therein. The NHM Vienna excludes all liability for damages<br>arising directly or indirectly from the use of the website.</p>"}');
...
SELECT pg_catalog.setval('tng.entities_id_seq', 63, true);
