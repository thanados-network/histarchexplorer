...
class Depiction:
    ...
    license_holder: Optional[str]
    creator: Optional[str]
    url: Optional[str]
    mimetype: Optional[str]
    iiif_manifest: Optional[str]
    iiif_base_path: Optional[str]
    entity_id: int
    main_image: bool
    render_type: str
...
#         self.render_type = self.get_image_render_type()
#
...
#
#
#     def get_image_render_type(self):
#         if self.mimetype in ["model/gltf-binary", "model/glb", "model/gltf+json"]:
#             self.render_type = "3d_model"
#         elif self.mimetype and self.mimetype.startswith("image/"):
#             self.render_type = "image"
#         elif self.mimetype == "application/pdf":
#             self.render_type = "pdf"
#         else:
#             self.render_type = "unknown"
#
#
#     @staticmethod
