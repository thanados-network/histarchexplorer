...
(async function initOverviewMap() {
    ...
    overviewMap.boxZoom.disable();
    overviewMap.doubleClickZoom.disable();
    overviewMap.dragPan.disable();
    overviewMap.dragRotate.disable();
    overviewMap.keyboard.disable();
    //overviewMap.scrollZoom.disable();
    overviewMap.touchZoomRotate.disable();
